...
// ==============================================================
`timescale 1 ns / 1 ps
module cnn_predict_conv1_w_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./cnn_predict_conv1_w_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./cnn_predict_conv1_w_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./cnn_predict_conv1_w_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./cnn_predict_conv1_w_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./cnn_predict_conv1_w_ROM_AUTO_1R.dat", rom4);
end
