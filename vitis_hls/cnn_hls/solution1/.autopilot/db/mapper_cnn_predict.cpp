...
using hls::sim::Byte;
extern "C" void cnn_predict(Byte<4>*, int, volatile void *);
extern "C" void apatb_cnn_predict_hw(volatile void * __xlx_apatb_param_img_in, volatile void * __xlx_apatb_param_steering_out) {
...
__xlx_img_in__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_img_in)[i]);
  ...
  // DUT call
  cnn_predict(__xlx_img_in__tmp_vec.data(), __xlx_offset_byte_param_img_in, __xlx_apatb_param_steering_out);
