set moduleName cnn_predict_Pipeline_VITIS_LOOP_38_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {cnn_predict_Pipeline_VITIS_LOOP_38_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln38 int 62 regular  }
	{ img_read float 32 regular {array 4096 { 3 0 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_in","offset": { "type": "dynamic","port_name": "img_in","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "img_read", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ img_read_address1 sc_out sc_lv 12 signal 2 } 
	{ img_read_ce1 sc_out sc_logic 1 signal 2 } 
	{ img_read_we1 sc_out sc_logic 1 signal 2 } 
	{ img_read_d1 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_read_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_read", "role": "we1" }} , 
 	{ "name": "img_read_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "img_read", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	img_read { ap_memory {  { img_read_address1 MemPortADDR2 1 12 }  { img_read_ce1 MemPortCE2 1 1 }  { img_read_we1 MemPortWE2 1 1 }  { img_read_d1 MemPortDIN2 1 32 } } }
}
